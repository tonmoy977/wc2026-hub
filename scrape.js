...
// ============================================================
//  DATA: FIXTURES (must be defined BEFORE any function uses them)
// ============================================================
const FIXTURES = [
...
// ============================================================
//  HELPER: norm() (must be defined BEFORE FIXTURE_MAP uses it)
// ============================================================
function norm(n){ 
  if(!n) return ''; 
  const s = n.trim(); 
...
// ============================================================
//  FIXTURE_MAP (built AFTER norm() exists)
// ============================================================
const FIXTURE_MAP = {};
FIXTURES.forEach(f=>{
...
main().catch(err => {
  ...
  process.exit(1); // Exit with error so GitHub Action shows failure
});
